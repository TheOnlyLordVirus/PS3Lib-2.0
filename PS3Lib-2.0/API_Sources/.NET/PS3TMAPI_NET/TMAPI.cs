...
//                PS3TMAPI.SNRESULT xxx = PS3TMAPI.ProcessAttach(Target, PS3TMAPI.UnitType.PPU, Parameters.ProcessID);
//                PS3TMAPI.SNRESULT xxxx = PS3TMAPI.ProcessContinue(Target, Parameters.ProcessID);
